...
grading = function (data) {
    ...
    self.ClassId = ko.observable(data ? data.ClassId : 0);
    ...
    self.IsProbation = ko.observable(data ? data.IsProbation : false).extend({ required: true });
...
viewModel = function () {
    ...
    self.deleteUrl = '/AcademicAffairs/DeleteGradClass';
