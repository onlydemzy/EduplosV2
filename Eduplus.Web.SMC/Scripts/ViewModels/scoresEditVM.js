...
student = function (data) {
    ...
    self.CA1 = ko.observable(data.CA1);
    self.CA2 = ko.observable(data.CA2);
    self.Exam = ko.observable(data.Exam);
...
viewModel = function () {
    ...
    self.CourseId.subscribe(function (corseId) {
        ...
        $.ajax({
            type: 'Get',
            contentyType: 'application/json;charset=utf-8',
            data: { courseId: corseId, semesterId: self.SemesterId(), flag: 2 },
